...
export class SearchCriteriaStore {
  ...
  public addCriteria(newCriteria: SearchCriteria): void {
    // let currentCriteria: SearchCriteria = new SearchCriteria({
    //   ...this._searchCriteria.getValue(),
    // });
    // let currentCriteria: SearchCriteria = Object.assign(Object.create(Object.getPrototypeOf(this._searchCriteria.getValue()),this._searchCriteria.getValue()))
