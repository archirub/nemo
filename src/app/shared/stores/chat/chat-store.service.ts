...
//     chats[chatIndex].recentMessage.push(message);
//     this.updateObservable(chats);
//   }
...
//     chats[chatIndex].recentMessage.splice(messageIndex, 1);
...
//     const index: number = chat.recentMessage.findIndex(
//       (_message) =>
