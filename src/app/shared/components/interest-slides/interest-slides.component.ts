import { Component, Input, AfterViewInit, QueryList, ElementRef, ViewChild } from "@angular/core";
...
export class InterestSlidesComponent implements AfterViewInit {
    ...
    ngAfterViewInit() {
        this.pictures = this.scOptions.path;
        this.names = this.scOptions.interest;
